...
const (
	...
	StaticAssets = "./src/github.com/liukunxin/superstar-db/web/public/"
	// Favicon is the relative 9to the "StaticAssets") favicon path for our app.
	Favicon = "favicon.ico"
)

// Configure accepts configurations and runs them inside the Bootstraper's context.
func (b *Bootstrapper) Configure(Configure func(b *bootstrap.Bootstrapper), Configure2 func(b *bootstrap.Bootstrapper), cs ...Configurator) {
	for _, c := range cs {
		c(b)
	}
}
